...
$(document).click(function(event) {
    ...
    if(currentSelectEl[0].nodeName == 'H2' || currentSelectEl[0].nodeName == 'H3' && typeof currentSelectParent != 'undefined') {
    ...
    if(currentSelectEl[0].nodeName == 'H2' || currentSelectEl[0].nodeName == 'H3') {
